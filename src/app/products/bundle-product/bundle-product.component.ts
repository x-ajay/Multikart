...
export class BundleProductComponent {
 ...
 ngOnInit(): void {
   ...
   targetDate.setDate(targetDate.getDate() + 10); // Add 9 days to the current date
...
increaseQuantity() {
 ...
 //bundle together 
  //img
 public bundleImg1="https://multikart-react-reactpixelstrap.vercel.app/_next/static/media/001.fb2774aa.jpg";
 public bundleImg2="https://multikart-react-reactpixelstrap.vercel.app/_next/static/media/skirt.dee0b576.jpg";
 public bundleImg3="https://multikart-react-reactpixelstrap.vercel.app/_next/static/media/shoes.2daf32be.jpg";

 //price
 public shirtPrice:number= 55;
 public skirtPrice:number= 20;
 public bootPrice:number= 15;
